...
export const ordersMock: Order[] = [
  ...
  },
  {
    ...
    createdAt: '2023-11-19T02:40:10.000Z',
    orderPizza: [
      { id: 1, orderId: 2, recipeId: 1, currentStage: 'Dough', currentToppingIndex: '0' },
      { id: 2, orderId: 2, recipeId: 2, currentStage: 'Dough', currentToppingIndex: '0' },
      { id: 2, orderId: 2, recipeId: 2, currentStage: 'Dough', currentToppingIndex: '0' }
    ],
    dinner: { id: 2, name: 'William' }
  },
  {
    id: 3,
    cashRegisterId: 1,
    createdAt: '2023-11-19T02:40:10.000Z',
    orderPizza: [
      { id: 1, orderId: 3, recipeId: 2, currentStage: 'Dough', currentToppingIndex: '0' }
    ],
    dinner: { id: 3, name: 'Alex' }
  },
  {
    id: 4,
    cashRegisterId: 1,
    createdAt: '2023-11-19T02:40:10.000Z',
    orderPizza: [
      { id: 1, orderId: 4, recipeId: 1, currentStage: 'Dough', currentToppingIndex: '0' },
      { id: 2, orderId: 4, recipeId: 2, currentStage: 'Dough', currentToppingIndex: '0' },
      { id: 1, orderId: 4, recipeId: 1, currentStage: 'Dough', currentToppingIndex: '0' }
    ],
    dinner: { id: 4, name: 'Tom' }
  }
];
